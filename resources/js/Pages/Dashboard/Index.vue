...
<template>
    <AppLayout title="Dashboard Overview">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <!-- Summary Card: Periode -->
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 hover:border-primary-200 transition-colors">
            ...
            <!-- Summary Card: Standar (Admin/Pimpinan) -->
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                    <div class="w-12 h-12 rounded-full bg-primary-600 text-white flex items-center justify-center font-bold text-xl">
